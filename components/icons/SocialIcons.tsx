...
/** Monochrome mark — inherits currentColor, for use on tinted backgrounds. */
export function GoogleIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6} aria-hidden {...props}>
      <path d="M18.2 8.5A6.2 6.2 0 1 0 19 12.3h-6.3" />
    </svg>
  );
}

/**
 * Google's own four-colour "G". Left in brand colours deliberately: it is a
 * third-party trademark and is the mark people recognise as "reviews".
 */
